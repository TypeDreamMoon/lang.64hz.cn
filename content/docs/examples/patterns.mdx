---
title: 常用模式
description: 最小材质、共享头文件、Package、Function、UE 节点、ShaderFunction 和 VirtualFunction 示例。
---
...
Shader(Name="DreamMaterials/M_StaticSwitch")
{
    Properties = {
        ...
        StaticSwitchParameter UseDetail = true [Group="Switches", SortPriority=30, Description="Use detail color"];
    }
